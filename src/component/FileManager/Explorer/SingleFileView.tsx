...
import { FilePermission, FileResponse, Share } from "../../../api/explorer.ts";
...
const SingleFileView = forwardRef((_props, ref: React.Ref<any>) => {
  ...
  const permission = useMemo(() => {
    ...
    if (shareInfo && shareInfo.permissions) {
              ...
              >
                {shareInfo.unlocked && (
                  <PropTypography variant={"caption"} color={"text.secondary"}>
                    <LockClosedKey sx={{ fontSize: "20px!important" }} />
                    {permissionSummary}
                  </PropTypography>
                )}
                <PropTypography variant={"caption"} color={"text.secondary"}>
                ...
                {shareInfo.price && (
                  <PropTypography variant={"caption"} color={"text.secondary"}>
                    <Money sx={{ fontSize: "20px!important" }} />
