      ...
      <Table sx={{ width: "100%" }} size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell>
              <CellHeaderWithPadding>{t("application:modals.usedBy")}</CellHeaderWithPadding>
            </TableCell>
...
const ApplicationNameMap: {
  ...
  setPermission: "application:modals.setPermission",
  ...
  mount: "vas.mountPolicy",
  relocate: "application:fileManager.relocation",
};
