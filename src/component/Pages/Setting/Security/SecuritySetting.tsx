...
import LoginActivitiesList from "./LoginActivitiesList.tsx";
    ...
    <Stack spacing={3}>
      <SettingForm title={t("login.password")} lgWidth={5}>
        {setting.passwordless ? (
          <Alert severity={"info"}>{t("setting.passwordlessHint")}</Alert>
        ) : (
      ...
      <SettingForm title={t("setting.recentSignIn")} lgWidth={12}>
        <LoginActivitiesList settings={setting} />
      </SettingForm>
