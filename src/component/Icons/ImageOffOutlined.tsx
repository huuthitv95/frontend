...
export default function ImageOffOutlined(props: SvgIconProps) {
  return (
    <SvgIcon {...props}>
      ...
      <path d="M15.252 6.5a2.252 2.252 0 1 1 0 4.504 2.252 2.252 0 0 1 0-4.504Zm0 1.5a.752.752 0 1 0 0 1.504.752.752 0 0 0 0-1.504Z" />
    </SvgIcon>
  );
}
