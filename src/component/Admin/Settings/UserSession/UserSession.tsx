      ...
      <Stack spacing={5}>
        <SettingSection>
          ...
          <SettingSectionContent>
            ...
            <SettingForm title={t("vas.filterEmailProvider")} lgWidth={5}>
              <FormControl>
                <DenseSelect
                  onChange={(e) =>
                    setSettings({
                      mail_domain_filter: e.target.value as string,
                    })
                  }
                  value={values.mail_domain_filter}
                >
            ...
            <Collapse unmountOnExit in={!!values.mail_domain_filter && values.mail_domain_filter !== "0"}>
              <SettingForm title={t("vas.filterEmailProviderRule")} lgWidth={5}>
                <FormControl fullWidth>
                  <DenseFilledTextField
                    value={values.mail_domain_filter_list}
                    onChange={(e) =>
                      setSettings({
                        mail_domain_filter_list: e.target.value,
                      })
                    }
                    multiline
                    minRows={4}
            ...
            <SettingForm lgWidth={5}>
              <FormControl fullWidth>
                <FormControlLabel
                  control={
                    <Switch
                      checked={isTrueVal(values.disable_sub_adress_email)}
                      onChange={(e) =>
                        setSettings({
                          disable_sub_adress_email: e.target.checked ? "1" : "0",
                        })
                      }
                    />
                  }
        ...
        <SettingSection>
          ...
          <SettingSectionContent>
            <SettingForm lgWidth={5}>
              <SSOSettings values={values} onChange={setSettings} />
            </SettingForm>
          </SettingSectionContent>
        </SettingSection>
        <SettingSection>
