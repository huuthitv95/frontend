          ...
          <SettingSectionContent>
            ...
            <SettingForm title={t("settings.announcement")} lgWidth={5}>
              <FormControl fullWidth>
                <DenseFilledTextField
                  fullWidth
                  onChange={(e) => setSettings({ siteNotice: e.target.value })}
                  value={values.siteNotice}
                  multiline
                  rows={4}
                />
          ...
          <SettingSectionContent>
            ...
            <SettingForm title={t("vas.appFeedback")} lgWidth={5}>
              <FormControl fullWidth>
                <DenseFilledTextField
                  fullWidth
                  onChange={(e) => setSettings({ app_feedback_link: e.target.value })}
                  value={values.app_feedback_link}
                />
            ...
            <SettingForm title={t("vas.appForum")} lgWidth={5}>
              <FormControl fullWidth>
                <DenseFilledTextField
                  fullWidth
                  onChange={(e) => setSettings({ app_forum_link: e.target.value })}
                  value={values.app_forum_link}
                />
                <NoMarginHelperText>{t("vas.appLinkDes")}</NoMarginHelperText>
              </FormControl>
            </SettingForm>
