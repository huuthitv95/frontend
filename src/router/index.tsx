...
import OpenIDCallback from "../component/Pages/Login/Signin/OpenIDCallback.tsx";
        ...
        children: [
          {
            path: "stripe/:id",
            async lazy() {
              let { PaymentCallback } = await import("../component/Pages/Pages");
              return { Component: PaymentCallback };
            },
          },
          {
