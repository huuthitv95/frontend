...
export interface GlobalStateSlice {
  ...
  setPermissionDialogOpen?: boolean;
  setPermissionDialogFiles?: FileResponse[];
  ...
  reportAbuseDialogShare?: Share;
  reportAbuseDialogUser?: User;
  ...
  relocateDialogFiles?: FileResponse[];
  ...
  // Purchase share dialog
  purchaseShareDialogOpen?: boolean;
  purchaseShareDialogTarget?: Share;
  purchaseShareDialogFmIndex?: number;
...
export const globalStateSlice = createSlice({
  ...
  reducers: {
    ...
    setReportAbuseDialog: (state, action: PayloadAction<{ open: boolean; share?: Share; user?: User }>) => {
      state.reportAbuseDialogOpen = action.payload.open;
      state.reportAbuseDialogShare = action.payload.share;
      state.reportAbuseDialogUser = action.payload.user;
    },
    ...
    setPurchaseShareDialog: (state, action: PayloadAction<{ open: boolean; target?: Share; fmIndex: number }>) => {
      state.purchaseShareDialogOpen = action.payload.open;
      state.purchaseShareDialogTarget = action.payload.target;
      state.purchaseShareDialogFmIndex = action.payload.fmIndex;
    },
    closePurchaseShareDialog: (state) => {
      state.purchaseShareDialogOpen = false;
    },
    ...
    resetDialogs: (state) => {
      ...
      state.setPermissionDialogOpen = state.setPermissionDialogOpen ? false : undefined;
      state.manageShareDialogOpen = state.manageShareDialogOpen ? false : undefined;
      state.activityDialogOpen = state.activityDialogOpen ? false : undefined;
      ...
      state.relocateDialogOpen = state.relocateDialogOpen ? false : undefined;
    ...
    setRelocateDialog: (state, action: PayloadAction<{ open: boolean; files: FileResponse[] }>) => {
      state.relocateDialogOpen = action.payload.open;
      state.relocateDialogFiles = action.payload.files;
    },
    ...
    setSelectOptionDialog: (
      ...
      state.selectOptionDescription = action.payload.description;
    },
    ...
    setPermissionDialog: (state, action: PayloadAction<{ open: boolean; files: FileResponse[] }>) => {
      state.setPermissionDialogOpen = action.payload.open;
      state.setPermissionDialogFiles = action.payload.files;
    },
    closePermissionDialog: (state) => {
      state.setPermissionDialogOpen = false;
    },
    ...
    setShowActivityDialog: (state, action: PayloadAction<{ open: boolean; file: FileResponse }>) => {
      state.activityDialogOpen = action.payload.open;
      state.activityDialogFile = action.payload.file;
    },
    closeShowActivityDialog: (state) => {
